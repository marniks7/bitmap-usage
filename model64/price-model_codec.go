...
const (
	// ----- content types ----
	codecSelferCcUTF8696 = 1
	codecSelferCcRAW696  = 255
	// ----- value types used ----
	codecSelferValueTypeArray696     = 10
	codecSelferValueTypeMap696       = 9
	codecSelferValueTypeString696    = 6
	codecSelferValueTypeInt696       = 2
	codecSelferValueTypeUint696      = 3
	codecSelferValueTypeFloat696     = 4
	codecSelferValueTypeNil696       = 1
	codecSelferBitsize696            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil696 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct696 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer696 struct{}

func codecSelfer696False() bool { return false }
func codecSelfer696True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil696 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap696 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray696 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct696)
	}
}
...
func (x codecSelfer696) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer696
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer696) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer696
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer696) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer696
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer696) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer696
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer696) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer696
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer696) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer696
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
