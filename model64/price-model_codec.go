...
const (
	// ----- content types ----
	codecSelferCcUTF81636 = 1
	codecSelferCcRAW1636  = 255
	// ----- value types used ----
	codecSelferValueTypeArray1636     = 10
	codecSelferValueTypeMap1636       = 9
	codecSelferValueTypeString1636    = 6
	codecSelferValueTypeInt1636       = 2
	codecSelferValueTypeUint1636      = 3
	codecSelferValueTypeFloat1636     = 4
	codecSelferValueTypeNil1636       = 1
	codecSelferBitsize1636            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil1636 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct1636 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer1636 struct{}

func codecSelfer1636False() bool { return false }
func codecSelfer1636True() bool  { return true }
...
func (x *Price) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil1636 {
		*(x) = Price{}
	} else if yyct2 == codecSelferValueTypeMap1636 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray1636 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct1636)
	}
}
...
func (x codecSelfer1636) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer1636
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer1636) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer1636
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
