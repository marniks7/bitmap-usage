...
const (
	// ----- content types ----
	codecSelferCcUTF84654 = 1
	codecSelferCcRAW4654  = 255
	// ----- value types used ----
	codecSelferValueTypeArray4654     = 10
	codecSelferValueTypeMap4654       = 9
	codecSelferValueTypeString4654    = 6
	codecSelferValueTypeInt4654       = 2
	codecSelferValueTypeUint4654      = 3
	codecSelferValueTypeFloat4654     = 4
	codecSelferValueTypeNil4654       = 1
	codecSelferBitsize4654            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil4654 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct4654 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer4654 struct{}

func codecSelfer4654False() bool { return false }
func codecSelfer4654True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil4654 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap4654 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray4654 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct4654)
	}
}
...
func (x codecSelfer4654) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer4654
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4654) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer4654
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer4654) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer4654
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4654) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer4654
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer4654) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer4654
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4654) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer4654
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
