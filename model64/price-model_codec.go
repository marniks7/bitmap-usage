...
const (
	// ----- content types ----
	codecSelferCcUTF87672 = 1
	codecSelferCcRAW7672  = 255
	// ----- value types used ----
	codecSelferValueTypeArray7672     = 10
	codecSelferValueTypeMap7672       = 9
	codecSelferValueTypeString7672    = 6
	codecSelferValueTypeInt7672       = 2
	codecSelferValueTypeUint7672      = 3
	codecSelferValueTypeFloat7672     = 4
	codecSelferValueTypeNil7672       = 1
	codecSelferBitsize7672            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil7672 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct7672 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer7672 struct{}

func codecSelfer7672False() bool { return false }
func codecSelfer7672True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil7672 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap7672 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray7672 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct7672)
	}
}
...
func (x codecSelfer7672) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer7672
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer7672) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer7672
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer7672) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer7672
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer7672) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer7672
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer7672) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer7672
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer7672) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer7672
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
