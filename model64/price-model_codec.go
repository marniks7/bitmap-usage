...
const (
	// ----- content types ----
	codecSelferCcUTF88398 = 1
	codecSelferCcRAW8398  = 255
	// ----- value types used ----
	codecSelferValueTypeArray8398     = 10
	codecSelferValueTypeMap8398       = 9
	codecSelferValueTypeString8398    = 6
	codecSelferValueTypeInt8398       = 2
	codecSelferValueTypeUint8398      = 3
	codecSelferValueTypeFloat8398     = 4
	codecSelferValueTypeNil8398       = 1
	codecSelferBitsize8398            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil8398 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct8398 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer8398 struct{}

func codecSelfer8398False() bool { return false }
func codecSelfer8398True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil8398 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap8398 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray8398 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct8398)
	}
}
...
func (x codecSelfer8398) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer8398
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8398) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer8398
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer8398) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer8398
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8398) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer8398
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer8398) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer8398
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8398) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer8398
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
