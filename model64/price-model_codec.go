...
const (
	// ----- content types ----
	codecSelferCcUTF82053 = 1
	codecSelferCcRAW2053  = 255
	// ----- value types used ----
	codecSelferValueTypeArray2053     = 10
	codecSelferValueTypeMap2053       = 9
	codecSelferValueTypeString2053    = 6
	codecSelferValueTypeInt2053       = 2
	codecSelferValueTypeUint2053      = 3
	codecSelferValueTypeFloat2053     = 4
	codecSelferValueTypeNil2053       = 1
	codecSelferBitsize2053            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil2053 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct2053 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer2053 struct{}

func codecSelfer2053False() bool { return false }
func codecSelfer2053True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil2053 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap2053 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray2053 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct2053)
	}
}
...
func (x codecSelfer2053) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer2053
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer2053) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer2053
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2053) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer2053
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer2053) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer2053
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2053) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer2053
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer2053) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer2053
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
