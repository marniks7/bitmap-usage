...
const (
	// ----- content types ----
	codecSelferCcUTF86763 = 1
	codecSelferCcRAW6763  = 255
	// ----- value types used ----
	codecSelferValueTypeArray6763     = 10
	codecSelferValueTypeMap6763       = 9
	codecSelferValueTypeString6763    = 6
	codecSelferValueTypeInt6763       = 2
	codecSelferValueTypeUint6763      = 3
	codecSelferValueTypeFloat6763     = 4
	codecSelferValueTypeNil6763       = 1
	codecSelferBitsize6763            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil6763 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct6763 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer6763 struct{}

func codecSelfer6763False() bool { return false }
func codecSelfer6763True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil6763 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap6763 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray6763 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct6763)
	}
}
...
func (x codecSelfer6763) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer6763
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer6763) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer6763
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6763) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer6763
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer6763) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer6763
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6763) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer6763
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer6763) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer6763
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
