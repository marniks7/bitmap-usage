...
const (
	// ----- content types ----
	codecSelferCcUTF89672 = 1
	codecSelferCcRAW9672  = 255
	// ----- value types used ----
	codecSelferValueTypeArray9672     = 10
	codecSelferValueTypeMap9672       = 9
	codecSelferValueTypeString9672    = 6
	codecSelferValueTypeInt9672       = 2
	codecSelferValueTypeUint9672      = 3
	codecSelferValueTypeFloat9672     = 4
	codecSelferValueTypeNil9672       = 1
	codecSelferBitsize9672            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil9672 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct9672 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer9672 struct{}

func codecSelfer9672False() bool { return false }
func codecSelfer9672True() bool  { return true }
...
func (x *Price) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil9672 {
		*(x) = Price{}
	} else if yyct2 == codecSelferValueTypeMap9672 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray9672 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct9672)
	}
}
...
func (x codecSelfer9672) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer9672
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9672) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer9672
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
