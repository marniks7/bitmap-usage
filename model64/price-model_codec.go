...
const (
	// ----- content types ----
	codecSelferCcUTF86620 = 1
	codecSelferCcRAW6620  = 255
	// ----- value types used ----
	codecSelferValueTypeArray6620     = 10
	codecSelferValueTypeMap6620       = 9
	codecSelferValueTypeString6620    = 6
	codecSelferValueTypeInt6620       = 2
	codecSelferValueTypeUint6620      = 3
	codecSelferValueTypeFloat6620     = 4
	codecSelferValueTypeNil6620       = 1
	codecSelferBitsize6620            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil6620 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct6620 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer6620 struct{}

func codecSelfer6620False() bool { return false }
func codecSelfer6620True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil6620 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap6620 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray6620 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct6620)
	}
}
...
func (x codecSelfer6620) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer6620
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer6620) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer6620
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6620) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer6620
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer6620) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer6620
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer6620) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer6620
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer6620) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer6620
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
