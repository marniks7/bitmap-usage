...
const (
	// ----- content types ----
	codecSelferCcUTF84524 = 1
	codecSelferCcRAW4524  = 255
	// ----- value types used ----
	codecSelferValueTypeArray4524     = 10
	codecSelferValueTypeMap4524       = 9
	codecSelferValueTypeString4524    = 6
	codecSelferValueTypeInt4524       = 2
	codecSelferValueTypeUint4524      = 3
	codecSelferValueTypeFloat4524     = 4
	codecSelferValueTypeNil4524       = 1
	codecSelferBitsize4524            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil4524 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct4524 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer4524 struct{}

func codecSelfer4524False() bool { return false }
func codecSelfer4524True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil4524 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap4524 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray4524 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct4524)
	}
}
...
func (x codecSelfer4524) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer4524
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4524) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer4524
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer4524) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer4524
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4524) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer4524
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer4524) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer4524
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4524) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer4524
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
