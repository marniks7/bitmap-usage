...
const (
	// ----- content types ----
	codecSelferCcUTF84316 = 1
	codecSelferCcRAW4316  = 255
	// ----- value types used ----
	codecSelferValueTypeArray4316     = 10
	codecSelferValueTypeMap4316       = 9
	codecSelferValueTypeString4316    = 6
	codecSelferValueTypeInt4316       = 2
	codecSelferValueTypeUint4316      = 3
	codecSelferValueTypeFloat4316     = 4
	codecSelferValueTypeNil4316       = 1
	codecSelferBitsize4316            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil4316 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct4316 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer4316 struct{}

func codecSelfer4316False() bool { return false }
func codecSelfer4316True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil4316 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap4316 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray4316 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct4316)
	}
}
...
func (x *PriceCondition) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "IndexId":
			x.IndexId = (uint64)(r.DecodeUint64())
		case "IsDefault":
...
func (x codecSelfer4316) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer4316
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4316) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer4316
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer4316) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer4316
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4316) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer4316
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer4316) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer4316
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4316) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer4316
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
