...
func (s *Holder) findSpecBitmap(specId string) (*roaring64.Bitmap, error) {
...
func (s *Holder) findGroupBitmap(groupId string) (*roaring64.Bitmap, error) {
...
func (s *Holder) findBitmapByCharValue(cv model64.CharValue) (*roaring64.Bitmap, error) {
...
func (s *Holder) findBitmapByOffering(offeringId string) (*roaring64.Bitmap, error) {
...
func (s *Holder) FindPriceIdByIndex(ind uint64) (string, error) {
