...
ab-map-1:
	ab -k -c 1 -n 1000 -T application/json -p sample/search-price-request.json http://127.0.0.1:8091/v1/search/map/prices
ab-bitmap-20:
	ab -k -c 20 -n 100000 -T application/json -p sample/search-price-request.json http://127.0.0.1:8091/v1/search/bitmap/prices
ab-map-20:
	ab -k -c 20 -n 100000 -T application/json -p sample/search-price-request.json http://127.0.0.1:8091/v1/search/map/prices
ab-bulk-bitmap-1:
	ab -k -c 1 -n 100 -T application/json -p sample/search-price-bulk-request-10000.json http://127.0.0.1:8091/v4/search/bitmap/bulk/prices
ab-bulk-map-1:
	ab -k -c 1 -n 100 -T application/json -p sample/search-price-bulk-request-10000.json http://127.0.0.1:8091/v4/search/bitmap/bulk/prices
