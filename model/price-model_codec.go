...
const (
	// ----- content types ----
	codecSelferCcUTF84655 = 1
	codecSelferCcRAW4655  = 255
	// ----- value types used ----
	codecSelferValueTypeArray4655     = 10
	codecSelferValueTypeMap4655       = 9
	codecSelferValueTypeString4655    = 6
	codecSelferValueTypeInt4655       = 2
	codecSelferValueTypeUint4655      = 3
	codecSelferValueTypeFloat4655     = 4
	codecSelferValueTypeNil4655       = 1
	codecSelferBitsize4655            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil4655 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct4655 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer4655 struct{}

func codecSelfer4655False() bool { return false }
func codecSelfer4655True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil4655 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap4655 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray4655 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct4655)
	}
}
...
func (x codecSelfer4655) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer4655
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4655) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer4655
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer4655) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer4655
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4655) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer4655
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer4655) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer4655
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer4655) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer4655
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
