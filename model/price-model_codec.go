...
const (
	// ----- content types ----
	codecSelferCcUTF85987 = 1
	codecSelferCcRAW5987  = 255
	// ----- value types used ----
	codecSelferValueTypeArray5987     = 10
	codecSelferValueTypeMap5987       = 9
	codecSelferValueTypeString5987    = 6
	codecSelferValueTypeInt5987       = 2
	codecSelferValueTypeUint5987      = 3
	codecSelferValueTypeFloat5987     = 4
	codecSelferValueTypeNil5987       = 1
	codecSelferBitsize5987            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil5987 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct5987 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer5987 struct{}

func codecSelfer5987False() bool { return false }
func codecSelfer5987True() bool  { return true }
...
func (x *Price) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil5987 {
		*(x) = Price{}
	} else if yyct2 == codecSelferValueTypeMap5987 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray5987 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct5987)
	}
}
...
func (x codecSelfer5987) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer5987
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer5987) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer5987
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
