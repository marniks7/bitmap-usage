...
const (
	// ----- content types ----
	codecSelferCcUTF83536 = 1
	codecSelferCcRAW3536  = 255
	// ----- value types used ----
	codecSelferValueTypeArray3536     = 10
	codecSelferValueTypeMap3536       = 9
	codecSelferValueTypeString3536    = 6
	codecSelferValueTypeInt3536       = 2
	codecSelferValueTypeUint3536      = 3
	codecSelferValueTypeFloat3536     = 4
	codecSelferValueTypeNil3536       = 1
	codecSelferBitsize3536            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil3536 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct3536 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer3536 struct{}

func codecSelfer3536False() bool { return false }
func codecSelfer3536True() bool  { return true }
...
func (x *Price) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil3536 {
		*(x) = Price{}
	} else if yyct2 == codecSelferValueTypeMap3536 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray3536 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct3536)
	}
}
...
func (x codecSelfer3536) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer3536
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3536) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer3536
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
