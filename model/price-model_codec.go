...
const (
	// ----- content types ----
	codecSelferCcUTF88850 = 1
	codecSelferCcRAW8850  = 255
	// ----- value types used ----
	codecSelferValueTypeArray8850     = 10
	codecSelferValueTypeMap8850       = 9
	codecSelferValueTypeString8850    = 6
	codecSelferValueTypeInt8850       = 2
	codecSelferValueTypeUint8850      = 3
	codecSelferValueTypeFloat8850     = 4
	codecSelferValueTypeNil8850       = 1
	codecSelferBitsize8850            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil8850 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct8850 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer8850 struct{}

func codecSelfer8850False() bool { return false }
func codecSelfer8850True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil8850 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap8850 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray8850 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct8850)
	}
}
...
func (x codecSelfer8850) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer8850
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8850) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer8850
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer8850) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer8850
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8850) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer8850
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer8850) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer8850
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8850) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer8850
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
