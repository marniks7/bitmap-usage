...
const (
	// ----- content types ----
	codecSelferCcUTF86226 = 1
	codecSelferCcRAW6226  = 255
	// ----- value types used ----
	codecSelferValueTypeArray6226     = 10
	codecSelferValueTypeMap6226       = 9
	codecSelferValueTypeString6226    = 6
	codecSelferValueTypeInt6226       = 2
	codecSelferValueTypeUint6226      = 3
	codecSelferValueTypeFloat6226     = 4
	codecSelferValueTypeNil6226       = 1
	codecSelferBitsize6226            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil6226 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct6226 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer6226 struct{}

func codecSelfer6226False() bool { return false }
func codecSelfer6226True() bool  { return true }
...
func (x *Price) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil6226 {
		*(x) = Price{}
	} else if yyct2 == codecSelferValueTypeMap6226 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray6226 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct6226)
	}
}
...
func (x codecSelfer6226) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer6226
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer6226) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer6226
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
