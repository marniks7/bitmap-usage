...
const (
	// ----- content types ----
	codecSelferCcUTF8709 = 1
	codecSelferCcRAW709  = 255
	// ----- value types used ----
	codecSelferValueTypeArray709     = 10
	codecSelferValueTypeMap709       = 9
	codecSelferValueTypeString709    = 6
	codecSelferValueTypeInt709       = 2
	codecSelferValueTypeUint709      = 3
	codecSelferValueTypeFloat709     = 4
	codecSelferValueTypeNil709       = 1
	codecSelferBitsize709            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil709 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct709 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer709 struct{}

func codecSelfer709False() bool { return false }
func codecSelfer709True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil709 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap709 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray709 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct709)
	}
}
...
func (x codecSelfer709) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer709
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer709) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer709
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer709) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer709
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer709) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer709
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer709) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer709
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer709) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer709
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
