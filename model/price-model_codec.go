...
const (
	// ----- content types ----
	codecSelferCcUTF88124 = 1
	codecSelferCcRAW8124  = 255
	// ----- value types used ----
	codecSelferValueTypeArray8124     = 10
	codecSelferValueTypeMap8124       = 9
	codecSelferValueTypeString8124    = 6
	codecSelferValueTypeInt8124       = 2
	codecSelferValueTypeUint8124      = 3
	codecSelferValueTypeFloat8124     = 4
	codecSelferValueTypeNil8124       = 1
	codecSelferBitsize8124            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil8124 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct8124 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer8124 struct{}

func codecSelfer8124False() bool { return false }
func codecSelfer8124True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil8124 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap8124 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray8124 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct8124)
	}
}
...
func (x codecSelfer8124) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer8124
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8124) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer8124
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer8124) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer8124
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8124) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer8124
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer8124) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer8124
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer8124) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer8124
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
