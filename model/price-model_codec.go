...
const (
	// ----- content types ----
	codecSelferCcUTF89086 = 1
	codecSelferCcRAW9086  = 255
	// ----- value types used ----
	codecSelferValueTypeArray9086     = 10
	codecSelferValueTypeMap9086       = 9
	codecSelferValueTypeString9086    = 6
	codecSelferValueTypeInt9086       = 2
	codecSelferValueTypeUint9086      = 3
	codecSelferValueTypeFloat9086     = 4
	codecSelferValueTypeNil9086       = 1
	codecSelferBitsize9086            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil9086 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct9086 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer9086 struct{}

func codecSelfer9086False() bool { return false }
func codecSelfer9086True() bool  { return true }
...
func (x *Price) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil9086 {
		*(x) = Price{}
	} else if yyct2 == codecSelferValueTypeMap9086 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray9086 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct9086)
	}
}
...
func (x codecSelfer9086) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer9086
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer9086) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer9086
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
