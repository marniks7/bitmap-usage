...
const (
	// ----- content types ----
	codecSelferCcUTF83554 = 1
	codecSelferCcRAW3554  = 255
	// ----- value types used ----
	codecSelferValueTypeArray3554     = 10
	codecSelferValueTypeMap3554       = 9
	codecSelferValueTypeString3554    = 6
	codecSelferValueTypeInt3554       = 2
	codecSelferValueTypeUint3554      = 3
	codecSelferValueTypeFloat3554     = 4
	codecSelferValueTypeNil3554       = 1
	codecSelferBitsize3554            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil3554 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct3554 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer3554 struct{}

func codecSelfer3554False() bool { return false }
func codecSelfer3554True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil3554 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap3554 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray3554 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct3554)
	}
}
...
func (x codecSelfer3554) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer3554
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3554) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer3554
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3554) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer3554
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3554) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer3554
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer3554) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer3554
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer3554) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer3554
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
