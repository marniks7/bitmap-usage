...
const (
	// ----- content types ----
	codecSelferCcUTF87080 = 1
	codecSelferCcRAW7080  = 255
	// ----- value types used ----
	codecSelferValueTypeArray7080     = 10
	codecSelferValueTypeMap7080       = 9
	codecSelferValueTypeString7080    = 6
	codecSelferValueTypeInt7080       = 2
	codecSelferValueTypeUint7080      = 3
	codecSelferValueTypeFloat7080     = 4
	codecSelferValueTypeNil7080       = 1
	codecSelferBitsize7080            = uint8(32 << (^uint(0) >> 63))
	codecSelferDecContainerLenNil7080 = -2147483648
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct7080 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer7080 struct{}

func codecSelfer7080False() bool { return false }
func codecSelfer7080True() bool  { return true }
...
func (x *PriceCondition) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if yyct2 == codecSelferValueTypeNil7080 {
		*(x) = PriceCondition{}
	} else if yyct2 == codecSelferValueTypeMap7080 {
		...
		z.DecReadMapEnd()
	} else if yyct2 == codecSelferValueTypeArray7080 {
		...
		panic(errCodecSelferOnlyMapOrArrayEncodeToStruct7080)
	}
}
...
func (x codecSelfer7080) encSliceCharValue(v []CharValue, e *codec1978.Encoder) {
	var h codecSelfer7080
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer7080) decSliceCharValue(v *[]CharValue, d *codec1978.Decoder) {
	var h codecSelfer7080
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer7080) encChanFindPriceResponseBulk(v chan FindPriceResponseBulk, e *codec1978.Encoder) {
	var h codecSelfer7080
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer7080) decChanFindPriceResponseBulk(v *chan FindPriceResponseBulk, d *codec1978.Decoder) {
	var h codecSelfer7080
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer7080) encChanerror(v chan error, e *codec1978.Encoder) {
	var h codecSelfer7080
	z, r := codec1978.GenHelper().Encoder(e)
	_, _, _ = h, z, r
	if v == nil {
...
func (x codecSelfer7080) decChanerror(v *chan error, d *codec1978.Decoder) {
	var h codecSelfer7080
	z, r := codec1978.GenHelper().Decoder(d)
	_, _, _ = h, z, r
