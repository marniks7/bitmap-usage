...
// OptimizeBasedOnStats the idea of this optimization is Database Optimizer Statistics.
...
func (s *BitmapIndexService) OptimizeBasedOnStats() (*BitmapOptimizerStatistic, error) {
...
// OptimizeBitmapsInternalStructure change internal roaring bitmap containers to whatever is better for memory.
...
func (s *BitmapIndexService) OptimizeBitmapsInternalStructure() error {
